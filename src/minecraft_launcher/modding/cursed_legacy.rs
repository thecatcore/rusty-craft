...
use crate::minecraft_launcher::manifest::version::{Main, VersionType, Library};
...
const LIBS: [(&str, &str); 16] = [
    ("net.fabricmc:tiny-mappings-parser:0.2.2.14", "https://maven.fabricmc.net/"),
    ("net.fabricmc:sponge-mixin:0.8+build.18", "https://maven.fabricmc.net/"),
    ("net.fabricmc:tiny-remapper:0.3.0.70", "https://maven.fabricmc.net/"),
    ("net.fabricmc:fabric-loader-sat4j:2.3.5.4", "https://maven.fabricmc.net/"),
    ("com.google.jimfs:jimfs:1.1", "https://maven.fabricmc.net/"),
    ("org.ow2.asm:asm:9.0", "https://maven.fabricmc.net/"),
    ("org.ow2.asm:asm-analysis:9.0", "https://maven.fabricmc.net/"),
    ...
    ("com.google.code.gson:gson:2.8.6", "https://repo1.maven.org/maven2/"),
    ("net.fabricmc:access-widener:1.0.0", "https://maven.fabricmc.net/"),
    ("com.google.guava:guava:21.0", "https://maven.fabricmc.net/"),
    ("com.github.minecraft-cursed-legacy:Plasma:build.9", "https://jitpack.io/")
];
...
impl ModLoaderInstaller for CursedLegacyInstaller {
    ...
    fn create_profile(&self, mc_version: String, loader_version: String) -> Main {
        let id = self.get_profile_name_for_loader_version(mc_version.clone(), loader_version.clone());
        ...
        for lib in LIBS.iter() {
            libs.push(Library {
                ...
                natives: None,
                rules: None,
                url: if lib.1.is_empty() { None } else { 
